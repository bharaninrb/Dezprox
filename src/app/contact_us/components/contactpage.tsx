            ...
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Facing technical challenges or product concerns? We&apos;re
                  here to assist
                </p>
              </div>
            </div>
            <a
              href="mailto:dezprox25@gmail.com"
          ...
          <div className="bg-white shadow-lg rounded-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Let&apos;s collaborate on custom solutions or discuss product
                  insights
                </p>
              </div>
            </div>
            <a
              href="https://wa.me/918072818574"
              target="_blank"
              ...
              <defs>
                ...
                >
                  ...
                  <feMorphology
                    ...
                    operator="erode"
                    in="SourceAlpha"
                    result="effect1_dropShadow_275_4457"
                  />
                  <feOffset dy="20" />
                  ...
                  <feColorMatrix
                    type="matrix"
                    values="0 0 0 0 0.0627451 0 0 0 0 0.192157 0 0 0 0 0.301961 0 0 0 0.09 0"
                  />
                  <feBlend
                    mode="normal"
                  ...
                  <feMorphology
                    ...
                    operator="erode"
                    in="SourceAlpha"
                    result="effect2_dropShadow_275_4457"
                  />
                  <feOffset dy="6.38265" />
                  ...
                  <feColorMatrix
                    type="matrix"
                    values="0 0 0 0 0.0627451 0 0 0 0 0.192157 0 0 0 0 0.301961 0 0 0 0.173 0"
                  />
                  <feBlend
                    mode="normal"
                    in2="effect1_dropShadow_275_4457"
                    result="effect2_dropShadow_275_4457"
                  />
                  <feColorMatrix
                    in="SourceAlpha"
                  ...
                  <feMorphology
                    ...
                    operator="erode"
                    in="SourceAlpha"
                    result="effect3_dropShadow_275_4457"
                  />
                  <feOffset dy="2.41451" />
                  ...
                  <feColorMatrix
                    type="matrix"
                    values="0 0 0 0 0.0627451 0 0 0 0 0.192157 0 0 0 0 0.301961 0 0 0 0.196 0"
                  />
                  <feBlend
                    mode="normal"
                    in2="effect2_dropShadow_275_4457"
                    result="effect3_dropShadow_275_4457"
                  />
                  <feColorMatrix
                    in="SourceAlpha"
                  ...
                  <feMorphology
                    ...
                    operator="erode"
                    in="SourceAlpha"
                    result="effect4_dropShadow_275_4457"
                  />
                  ...
                  <feColorMatrix
                    type="matrix"
                    values="0 0 0 0 0.0627451 0 0 0 0 0.192157 0 0 0 0 0.301961 0 0 0 0.21 0"
                  />
                  <feBlend
                    mode="normal"
                    in2="effect3_dropShadow_275_4457"
                    result="effect4_dropShadow_275_4457"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect4_dropShadow_275_4457"
                    result="shape"
                  />
                </filter>
                <linearGradient
                  id="paint0_linear_275_4457"
                  x1="57"
                  y1="37"
                  x2="57"
                  y2="46"
